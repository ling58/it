		...
		{{csrf_field()}}
			<div class="container border border border-dark">
				<div class="container">
					...
					<input type="hidden" name="masuk" value="{{$data->masuk}}">
					...
					<div class="container">
						<div class="border-bottom border border-dark">
							...
							<div class="row">
								<div class="col-sm-5">
									Tanggal mulai kerja : {{$data->masuk}}
								</div>
								<div class="col-sm">
									Golongan : {{$data->level}}
								</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-3">
								<span class="font-weight-bold">1. PENGETAHUAN TEKNIS PROFESI :</span>
							</div>
							<div class="col-sm">
								<p>Menilai tingkat pengetahuan teknis profesi mencakup prinsip, metode dan proses yang dijalanakan dalam pekerjaannya serta bidang pekerjaan lain dalam unit kerjanya.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p1" required> 100</td>
							...
							<div class="col-sm-3">
								<span class="font-weight-bold">2. PENERAPAN PENGETAHUAN TEKNIS PROFESI :</span>
							</div>
							<div class="col-sm">
								<p>Menilai kemampuan dalam menerapkan pengetahuan teknis profesi pada pelaksaan tugas.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p2" required> 100</td>
							...
							<div class="col-sm-3">
								<span class="font-weight-bold">3. DAYA ANALISA & LOGIKA</span>
							</div>
							<div class="col-sm">
								<p>Menilai kemampuan untuk berpikir analitis, sistematis, obyektif dan logis.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p3" required> 100</td>
							...
							<div class="col-sm-3">
								<span class="font-weight-bold">4. PENYAJIAN LAPORAN :</span>
							</div>
							<div class="col-sm">
								<p>: Menilai kemampuan dalam menyajikan laporan tertulis.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p4" required> 100</td>
							...
							<div class="col-sm-3">
								<span class="font-weight-bold">5. KREATIFITAS :</span>
							</div>
							<div class="col-sm">
								<p>: Menilai kemampuan menampilkan pemikiran, ide-ide dan langkah-langkah baru yang positif dalam hal yang berkaitan dengan pekerjaanya maupun yang tidak.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p5" required> 100</td>
							...
							<div class="col-sm-3">
								<span class="font-weight-bold">6. BERPIKIR RASIONAL :</span>
							</div>
							<div class="col-sm">
								<p>: Menilai kemampuan berpikir dan bertindak yang dilandasi oleh kaidah berpikir logis.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p6" required> 100</td>
							...
							<div class="col-sm-3">
								<span class="font-weight-bold">7. TANGGUNG JAWAB :</span>
							</div>
							<div class="col-sm">
								<p>: Menilai tanggung hawabnya terhadap tugas mencakup tahap persiapan, pelaksanaan dan hasilnya.</p>
							</div>
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p7" required> 100</td>
							...
							<div class="table-responsive container">
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p8" required> 100</td>
							...
							<div class="col-sm-3">
								...
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p9" required> 100</td>
							...
							<div class="col-sm-3">
								...
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p10" required> 100</td>
								...
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p11" required> 100</td>
								...
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p12" required> 100</td>
								...
								<table class="table-hover tkuesioner border">
									<tr>
										<td width="90px" class="border border-dark"><input type="radio" value="100" name="p13" required> 100</td>
								...
								<div class="form-group">
										...
										<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="kekuatan" required></textarea>
									</div>
									<div class="form-group">
										<label for="exampleFormControlTextarea1">Kelemahan/Hal-hal yang perlu di perbaiki.</label>
										<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="kelemahan" required></textarea>
									</div>
									<div class="form-group">
										<label for="exampleFormControlTextarea1">langkah apa yang anda rencakanan untuk mengembangkan karyawan ini.</label>
										<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="rencana" required></textarea>
									</div>
