    ...
    @section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="panel">
                        ...
                        <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#createSettingStaff">
                                Tambah
                        </button>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{$i->jabatan_id['name']}}</td>
                                        <td>
                                            <a href="/setting/{{$i->id}}/delete" class="btn btn-danger fa fa-trash-o" type="button" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"> Hapus</a>
                                        </td>
                                    </tr>
                                </tbody>
                                @endforeach
        ...
        <div class="modal fade" id="createSettingStaff" tabindex="-1" role="dialog" aria-labeledby="exampleModalLabel" aria-hidden="true">
